...
Automated device testing|[X.](http:// "BrowserSync")| |[X.](https://github.com/mgechev/angular-seed/wiki/Add-a-Proxy-to-browsersync "BrowserSync")| | |
...
[Share code between projects (?)](https://github.com/mgechev/angular-seed/wiki/Multiple-Applications "Require.JS lets you do this.  If Angular 2 will use ES6 modules, then this won't be necessary")| | |[UNIQUE.](https://github.com/mgechev/angular-seed/wiki/Multiple-Applications "mgechev's angular-seed")| | |

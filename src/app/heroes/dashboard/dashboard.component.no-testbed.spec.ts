...
import { addMatchers } from '../../shared/test/util';
...
describe('DashboardComponent: w/o Angular TestBed', () => {
  ...
  let crisisService: FakeCrisisService;
  let router: Router;
  ...
  beforeEach(() => {
    ...
    crisisService = new FakeCrisisService();
    comp = new DashboardComponent(router, heroService, crisisService);
  });
  ...
  it('should tell ROUTER to navigate by hero id', () => {
    ...
    expect(navArgs).toBe('/heroes/hero/42', 'should nav to HeroDetail for Hero 42');
  });

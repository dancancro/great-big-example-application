...
import org.exampleapps.greatbig.config.ApplicationProperties;
import org.exampleapps.greatbig.config.DefaultProfileUtil;
...
public class GreatBigExampleApplicationApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(GreatBigExampleApplicationApp.class);

    private final Environment env;

    public GreatBigExampleApplicationApp(Environment env) {
        this.env = env;
    }
